...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative overflow-hidden rounded-3xl border border-white/[0.1] group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none text-black dark:text-white justify-between flex flex-col space-y-4",
        className
      )}
      style={{
