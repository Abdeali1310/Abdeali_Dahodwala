...
export const gridItems = [
  {
    ...
    description: "",
    className: "lg:col-span-3 text-white md:col-span-6 md:row-span-4 lg:min-h-[60vh]",
...

  {
    ...
    description: "",
    className: "md:col-span-3 text-white md:row-span-2",
  ...
  },
  {
    ...
    description: "",
    className: "lg:col-span-2 text-white hidden lg:block md:col-span-3 md:row-span-1",
    imgClassName: "",
