...
export default function Footer() {
  return (
    <footer className=" text-zinc-900 dark:text-white py-10 px-6 mt-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <li><a href="/projects" className="hover:text-black dark:hover:text-white transition">Projects</a></li>
            <li><a href="/skills" className="hover:text-black dark:hover:text-white transition">Skills</a></li>
        ...
        <div>
          ...
          <div className="flex gap-6 text-zinc-600 dark:text-zinc-400">
            <a
              ...
              className="hover:text-black dark:text-zinc-400 dark:hover:text-white transition"
            >
              <Github />
            </a>
            <a
        ...
        <div>
          ...
          <p className="text-sm text-zinc-600 flex gap-2 items-center dark:text-zinc-400"><FaLocationDot /> Ahmedabad, India</p>
          <p className="text-sm text-zinc-600 flex gap-2 dark:text-zinc-400 items-center"><FaEnvelope /> abdeali.dahodwala@outlook.com</p>
        </div>
      </div>
