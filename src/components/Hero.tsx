    ...
    <>
      <div className=" data-scroll-section pb-20 data-scroll pt-36">
        <div className="hidden dark:block">
          ...
          />
          <Spotlight
            className="h-[80vh] w-[80vw] top-30 left-full"
            fill="purple"
          />
          <Spotlight className="left-80 top-28 h-[80vh] w-[50vw]" fill="blue" />
          <Spotlight className="-left-10 top-15 md:hidden h-screen w-[80vw]" fill="blue" />
        </div>
      </div>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <p className="text-center font-serif tracking-wider md:tracking-wider mb-7 md:mb-4  text-md md:text-lg lg:text-2xl">
